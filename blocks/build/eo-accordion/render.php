...
$title_font     = isset( $attributes['titleFontSize'] ) ? esc_attr( $attributes['titleFontSize'] ) : '';
$title_attrs    = $title_font ? sprintf( ' style="font-size:%s;"', $title_font ) : '';
$subtitle       = ! empty( $attributes['subtitle'] ) ? $attributes['subtitle'] : '';
$subtitle_font  = isset( $attributes['subtitleFontSize'] ) ? esc_attr( $attributes['subtitleFontSize'] ) : '';
$subtitle_attrs = $subtitle_font ? sprintf( ' style="font-size:%s;"', $subtitle_font ) : '';
	...
	<div class="eo-accordion__main-container <?php echo esc_attr( $is_active ); ?>">
		<div class="eo-accordion__header">
			<div class="eo-accordion__header-container">
				<?php echo sprintf("<%s class='eo-accordion__title'%s>%s</%s>",
					esc_attr( $titleTag ),
                    $title_attrs,
                    wp_kses_post( $title ),
					esc_attr( $titleTag )
			...
			<?php if ( ! empty( $subtitle ) ) : ?>
				<div class="eo-accordion__subtitle" <?php echo $subtitle_attrs; ?>><?php echo esc_html( $subtitle ); ?></div>
			<?php endif; ?>
		</div>
