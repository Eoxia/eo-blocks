...
/* harmony import */ var _scss_editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scss/editor.scss */ "./blocks/src/digirisk-list-risk/scss/editor.scss");
...
function Edit() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    fetch(urlApi).then(resp => resp.json()).then(data => {
      setData(data);
    }).catch(error => {
      console.log(error);
    });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, data && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, 'Risques gris: ' + (data[1] || 0) + '. Risques Orange: ' + (data[2] || 0) + ' Risques Rouge: ' + (data[3] || 0) + '. Risques noir: ' + (data[4] || 0)));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/digirisk-list-risk","version":"0.1.0","title":"Digirisk List Risk","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"digirisk-list-risk","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
