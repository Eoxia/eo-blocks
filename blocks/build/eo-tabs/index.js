...
function Edit({
  ...
  const [activeTab, setActiveTab] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(attributes.activeTabIndex || '');
  const handleSetActiveTab = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useCallback)(tabKey => {
    setActiveTab(tabKey);
    setAttributes({
   ...
   */
  const handleRemoveTabSync = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useCallback)((tabKey, initiatorType) => {
  ...
  const handleAddTabSync = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useCallback)((tabKey, initiatorType) => {
  ...
  const lastInnerBlocksRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(null); // Assurez-vous d'avoir useRef pour l'état précédent
